  ...
  return (
    <main className="flex flex-1 flex-col p-4 justify-center gap-12 items-center ">
      ...
      <div className="font-bold text-xl text-center">
        ...
        <h2>Classic board games with power-ups.</h2>
      </div>
...
const Card = ({ link, title, icon }: CardProps) => {
  ...
  return(
      <a href={`/${link}`} className="bg-white flex flex-col gap-6 h-full min-w-64 border-2 border-main-purple max-w-80 rounded-lg p-8 shadow-md shadow-zinc-400 hover:shadow-main-purple transition-all duration-300">
